...
source activate polyfun-lock

python compute_ldscores_from_ld.py --annot AML_data/annots/baselineLF2.2.UKB/baselineLF2.2.UKB.1.annot.parquet --n 12500 --out AML_data/ldscores/chr2.paraquet ../ldstore/HRCout_status_hit1_chr2.bcor
