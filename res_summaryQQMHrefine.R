...
chrom.res <- rbindlist(chrom.res, use.names=TRUE, fill=TRUE)[info_score > 0.5 & cases_maf > 0.0095 & controls_maf > 0.0095, ]
...
## MH plot
png(paste0(phenoprefix, dataprefix, "mhHRCresRefine.png"), type="cairo", width=14, height=9, units="in", res=300)
...
## QQ plot
png(paste0(phenoprefix, dataprefix, "qqHRCresRefine.png"), type="cairo", width=8, height=6, units="in", res=300)
