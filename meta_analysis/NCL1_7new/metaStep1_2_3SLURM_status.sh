...
#declare -a nophenos=('Trans' 'Complex' 'del5_7' 'Trisomies' 'Any.Monosomy' 'monosomal.karyotype' 'anyTriMon' )
...
plink --meta-analysis ../${nophenos[i]}_MAF0.02*assoc.res + logscale report-all \\
