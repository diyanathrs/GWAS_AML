...
folderlist=NCLpcspeDataNew.lst
...
R CMD BATCH --vanilla --no-timing '--args dataprefix="'\${prefix}'" phenoprefix="'${nophenos[i]}'" res.dir="'\${resdir}'" maf="'0.0095'" ' metaNCL_gwas_maf.R
