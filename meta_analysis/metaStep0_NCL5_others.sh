...
folderlist=NCLpcspeData_no67.lst
...
#declare -a nophenos=( 'Trans' 'Complex' 'del5_7' 'Trisomies' 'Any.Monosomy' 'monosomal.karyotype' 'anyTriMon' 'abnormality' )
#declare -a nophenos=( 'Complex' 'del5_7' 'Trisomies' 'Any.Monosomy' 'anyTriMon' 'abnormality' )
