...
#folderlist="NCLpcspeData_no567.lst"

# no. phenos
# nophenos=(`cat ${listdir}/${prefix}_chr1pheno.lst | awk '{print $1}' `)

# below is for N=5 (NCLpcspeData_no6.lst)
declare -a nophenos=('Trans' 'Complex' 'del5_7' 'Trisomies' 'Any.Monosomy' )
# below is for NCLpcspeData_no567.lst
#declare -a nophenos=('CBF' 't15_17')
...
plink --meta-analysis ../assoc_res_maf2_50cases/${nophenos[i]}_MAF0.02*assoc.res + logscale report-all \\
