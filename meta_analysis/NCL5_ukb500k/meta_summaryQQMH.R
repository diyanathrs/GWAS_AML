...
chrom.res1 <- chrom.res[N==4 & !is.na(P), ]


png(paste0(phenoprefix, "_meta_", dataprefix, "mh_HRCN4.png"), type="cairo", width=14, height=9,units="in", res=300)
#highKARN1 <- kkkk[CHR==9 & BP>=731563 & BP<=761563, SNP]
...
png(paste0(phenoprefix, "_meta_" , dataprefix, "qq_HRCN4.png"), type="cairo", width=8, height=6, units="in", res=300)
