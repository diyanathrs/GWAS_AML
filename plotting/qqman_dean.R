mh.dean <- function (x, chr = "CHR", bp = "BP", p = "P", snp = "SNP", col = c("gray10", 
          ...
          annotatePval = NULL, annotateTop = TRUE, ...) 
{
  ...
  def_args <- list(xaxt = "n", bty = "n", xaxs = "i", yaxs = "i", 
                   las = 1, pch = 20, xlim = c(xmin, xmax), ylim = c(0, 10e-10), xlab = xlabel, ylab = expression(-log[10](italic(p))))
  dotargs <- list(...)
      ...
      if (logp) {
        with(subset(d, P <= annotatePval), textxy(pos, 
                                                  ...
                                                  cex = 0.85), ...)
                                                     ...
                                                     P, offset = 0.625, labs = topHits$SNP, cex = 0.85), 
                ...)
    }
    else {
