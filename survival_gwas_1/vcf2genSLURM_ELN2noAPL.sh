...
samplelist="/mnt/storage/nobackup/proj/jamgaml/dean_AML/HRCimpvData/AMLsurMeta/pheno_2024/AML_subset_ELN2noAPL.txt"

echo "${samplelist}"


mkdir -p impvSubset_ELN2noAPL
...
#SBATCH --array=1-22
#SBATCH --chdir=${rootpath}/impvSubset_ELN2noAPL
